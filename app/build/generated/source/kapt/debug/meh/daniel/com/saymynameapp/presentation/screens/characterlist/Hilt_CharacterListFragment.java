...
public abstract class Hilt_CharacterListFragment<ViewModel extends BaseViewModel, Binding extends ViewBinding> extends BaseFragment<ViewModel, Binding> implements GeneratedComponentManagerHolder {
  ...
  Hilt_CharacterListFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CharacterListFragment_GeneratedInjector) this.generatedComponent()).injectCharacterListFragment(UnsafeCasts.<CharacterListFragment>unsafeCast(this));
    }
  }
