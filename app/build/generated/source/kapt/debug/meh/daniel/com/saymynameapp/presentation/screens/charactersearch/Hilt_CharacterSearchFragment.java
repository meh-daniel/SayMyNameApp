...
public abstract class Hilt_CharacterSearchFragment<ViewModel extends BaseViewModel, Binding extends ViewBinding> extends BaseFragment<ViewModel, Binding> implements GeneratedComponentManagerHolder {
  ...
  Hilt_CharacterSearchFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CharacterSearchFragment_GeneratedInjector) this.generatedComponent()).injectCharacterSearchFragment(UnsafeCasts.<CharacterSearchFragment>unsafeCast(this));
    }
  }
