...
public abstract class Hilt_CharacterDetailInfoFragment<ViewModel extends BaseViewModel, Binding extends ViewBinding> extends BaseFragment<ViewModel, Binding> implements GeneratedComponentManagerHolder {
  ...
  Hilt_CharacterDetailInfoFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CharacterDetailInfoFragment_GeneratedInjector) this.generatedComponent()).injectCharacterDetailInfoFragment(UnsafeCasts.<CharacterDetailInfoFragment>unsafeCast(this));
    }
  }
